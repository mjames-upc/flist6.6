...
RSpec.describe "franken_breweries/new", type: :view do
  before(:each) do
    assign(:franken_brewery, FrankenBrewery.new(
  ...
  it "renders new franken_brewery form" do
    render

    assert_select "form[action=?][method=?]", franken_breweries_path, "post" do
